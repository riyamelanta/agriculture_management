        ...
        <div class="row w-100 mx-0" >
          ...
          <div class="col-lg-4 mx-auto" >
            <div class="auth-form-light text-left py-5 px-4 px-sm-5" >
              ...
              <form class="pt-3" method="post" action="../controller/login_supervisor.php">
                <div class="form-group">
                  <input type="email" class="form-control form-control-lg" id="exampleInputEmail1" placeholder="Email" name="semail" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$"/ title=" Email should have no capital letter">
                </div>
                <div class="form-group">
                  <input type="password" class="form-control form-control-lg" id="exampleInputPassword1" placeholder="Password" name="spass">
                </div>
                <div class="mt-3">
                  <button class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" name="signin">SIGN IN</button>
           
               <div class="text-center mt-4 font-weight-light">
                  Don't have an account? <a href="sp_reg.php" class="text-primary">Create</a>
                </div>
              </form>
            </div>
          </div>
